...
######################################################
    ...
    def __init__(self):
    #####################################################
        rospy.init_node("l_pid_velocity")
        ...
        rospy.Subscriber("l_wheel_enc", Int32, self.wheelCallback) 
        rospy.Subscriber("l_wheel_vtarget", Float32, self.targetCallback) 
        self.pub_motor = rospy.Publisher('l_motor_cmd',Float32, queue_size=10) 
        self.pub_vel = rospy.Publisher('l_wheel_vel', Float32, queue_size=10)
