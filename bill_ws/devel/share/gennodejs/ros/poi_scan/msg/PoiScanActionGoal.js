...
let PoiScanGoal = require('./PoiScanGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PoiScanActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PoiScanGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PoiScanGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PoiScanActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PoiScanGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PoiScanGoal()
    }
...
module.exports = PoiScanActionGoal;
